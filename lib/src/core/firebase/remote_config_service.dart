...
class RemoteConfigService {
  ...
  bool get requirePhoneVerification =>
      _config.getBool('require_phone_verification');
  ...
  bool get ffProductVariantsEditor =>
      _config.getBool('ff_product_variants_editor');
  bool get ffPrintDiagnostics => _config.getBool('ff_print_diagnostics');
  bool get ffDeliveryRadiusSettingsV2 =>
      _config.getBool('ff_delivery_radius_settings_v2');
